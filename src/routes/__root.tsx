...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  reportError(error, {}, { mechanism: "react_error_boundary", handled: false });
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Futuristisches Portfolio eines AI Engineers und Software-Architekten." },
      { property: "og:title", content: "Service-mit-Herz — AI Architecture" },
      { property: "og:description", content: "AI Architektur, Engineering und KI-Projekte mit Substanz." },
